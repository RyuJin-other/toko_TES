                            ...
                            <div class="pd-desc">
                                ...
                                <?php if ($session->get('isLoggedIn')) : ?>
                                    <div class="form-group" id="diskon">
                                        <h4>Masukkan Diskon</h4>
                                        <select class="form-control" id="kode">
                                            <option value="0" id="1">Select diskon</option>
    ...
    $('document').ready(function() {
        ...
        $("#kode").on('change', function() {
            ...
            if (jumlah_pembelian > 1){
                for (let i = 0 ; i <jumlah_pembelian; i++){
                    
                    ntotal += harga ;
                    
                }
                var total_harga = ntotal  ;
                var jumlah_total = total_harga - (total_harga * kode / 100) + ongkir
                
            }
            else {
                var total_harga = (harga * jumlah_pembelian)  ;
                var jumlah_total = total_harga - (total_harga * kode / 100) + ongkir
            }
